...
function SupportCard({
  ...
  const Inner = (
    <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04] backdrop-blur-xl p-6 h-full group hover:border-white/[0.14] hover:bg-white/[0.06] transition-all">
      <div className={`inline-flex h-12 w-12 items-center justify-center rounded-2xl ${accentClass} mb-4`}>
        {icon}
      </div>
      <h3 className="text-base font-semibold text-white mb-1">{title}</h3>
      <p className="text-sm text-white/60 mb-3">{channel}</p>
      <div className="flex items-center gap-2">
        <Clock className="h-3.5 w-3.5 text-white/30" />
        <span className="text-xs text-white/40">{sla}</span>
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      <button
        ...
        className="w-full flex items-center justify-between gap-4 px-5 py-4 text-left bg-white/[0.03] hover:bg-white/[0.05] transition-colors"
      >
  ...
  return (
    <div className="min-h-screen bg-[#0a0918]">
      ...
      <div className="relative overflow-hidden">
        <div className="pointer-events-none absolute -top-40 left-1/4 h-96 w-96 rounded-full bg-emerald-600/15 blur-[120px]" />
        <div className="pointer-events-none absolute top-0 right-1/3 h-64 w-64 rounded-full bg-teal-600/10 blur-[100px]" />
        ...
        <div className="relative px-4 pt-20 pb-12 text-center">
          ...
          >
            <span className="inline-flex items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/10 px-4 py-1.5 text-xs font-medium text-emerald-300 mb-6">
      ...
      <div className="mx-auto max-w-4xl px-4 pb-24 space-y-20">
        ...
        <section>
          ...
          >
            <h2 className="text-2xl font-bold text-white">Süreç Adımları</h2>
            <p className="mt-2 text-sm text-white/40">Satış tamamlandıktan sonra süreç bu adımları izler</p>
          </motion.div>

          <div className="relative">
            {/* Vertical connector line */}
            <div className="absolute left-6 top-8 bottom-8 w-px bg-gradient-to-b from-emerald-500/40 via-teal-500/20 to-transparent" />
                        ...
                        <span
                          className={`rounded-full px-2.5 py-0.5 text-[11px] font-medium border ${
                            step.done
                              ...
                              : 'bg-white/[0.05] border-white/[0.07] text-white/40'
                          }`}
                        >
                          {step.timing}
                        </span>
        ...
        <section>
          ...
          >
            <h2 className="text-2xl font-bold text-white">Destek Kanalları</h2>
            <p className="mt-2 text-sm text-white/40">Sorularınız için birden fazla kanaldan ulaşabilirsiniz</p>
          </motion.div>
        ...
        <section>
          ...
          >
            ...
            <p className="mt-2 text-sm text-white/40">Satış sonrası süreçle ilgili merak edilenler</p>
          </motion.div>
        ...
        <motion.section
          ...
          className="rounded-2xl border border-white/[0.08] bg-gradient-to-br from-emerald-600/10 via-teal-600/6 to-transparent backdrop-blur-xl p-8 sm:p-10 text-center"
        >
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center gap-3">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 px-6 py-3 text-sm font-semibold text-white hover:opacity-90 transition-opacity"
            >
              İletişime Geç
            ...
            <Link
              href="/faq"
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.04] px-6 py-3 text-sm font-semibold text-white hover:bg-white/[0.08] transition-colors"
            >
              Tüm SSS
            </Link>
          </div>
