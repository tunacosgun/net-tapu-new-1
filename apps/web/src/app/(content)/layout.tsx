        ...
        <aside className="hidden lg:block lg:w-60 lg:shrink-0">
          <div className="sticky top-24">
            ...
            <div className="mt-6 rounded-xl bg-gradient-to-br from-brand-50 to-brand-100/50 p-4 border border-brand-100">
              ...
              <Link href="/about" className="mt-3 inline-flex items-center gap-1 rounded-md bg-brand-500 px-3 py-1.5 text-xs font-medium text-white hover:bg-brand-600 transition-colors">
                Bize Ulaşın
